(function(){
  ...
  function role(v){var r=normalize(v).normalize('NFD').replace(/[\u0300-\u036f]/g,'').replace(/\s+/g,'_');if(r==='DESENVOLVER_MASTER')r='DESENVOLVEDOR_MASTER';if(r==='LIDER'||r==='LIDER(A)'||r==='LIDER_A')r='LIDER';return r;}
